...
\textbf{Answer}: Below is a table summarizing my results. For models that had hyper parameters, I specific the parameters and only show that model's accuracy and kappa.
