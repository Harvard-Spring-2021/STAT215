...
![cBioPortal Results](part3/q3.1.png)
...
![cBioPortal Mutation Tab for IDH1](part3/q4.1.png)
...
![cBioPortal Mutation Tab for IDH1](part3/q5.1.png)
...
**Answer**: The disease is Glioblastoma and the gene is IDH1. That is what I searched for on the Clincal Trials website. The tool provide total number of matches for my searches as well as the ability to filter based on recruiting. Hence I could just use the portal to find the numbers.

For the gene IDH1, I found 8 trials with 3 actively recruiting patients which this patient could potentially join.

![Total Trials IDH1](part3/q6.1.png)

![Actively Recruiting IDH1](part3/q6.2.png)


For the gene Glioblastoma, I found 1629 trials with 321 actively recruiting patients which this patient could potentially join.

![Total Trials Glioblastoma](part3/q6.3.png)

![Actively Recruiting Glioblastoma](part3/q6.4.png)
